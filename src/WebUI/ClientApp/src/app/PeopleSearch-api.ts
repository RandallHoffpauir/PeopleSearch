        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<PersonsVm>><any>_observableThrow(e);
                }
            } else
                return <Observable<PersonsVm>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<PersonsVm> {
        ...
        if (status === 200) {
            ...
            result200 = PersonsVm.fromJS(resultData200);
...
export class PersonsVm implements IPersonsVm {
    persons?: PersonDto[] | undefined;

    constructor(data?: IPersonsVm) {
        if (data) {
    ...
    static fromJS(data: any): PersonsVm {
        data = typeof data === 'object' ? data : {};
        let result = new PersonsVm();
        result.init(data);
        return result;
    }
